...
GameOverState::GameOverState(StateManager* manager, Platform *platform, DataManager *dtmng)
	...
	while (SDL_PollEvent(&events))
	{
		...
		case SDL_MOUSEBUTTONDOWN:
			...
			case SDL_BUTTON_LEFT:
				...
				{
					stateManager->changeState(new GameState(stateManager, platform, dtmng, new RandMap(dtmng->getMapManager(), dtmng->getTileTypeManager(), dtmng->getCreatureManager(), 9), 0));
					return false;
				}
